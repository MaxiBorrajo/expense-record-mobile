...
const translations = {
  en: {
    ...
    incomeOfMonth: "Income of the month",
    lossOfMonth: "Losses of the month",
  ...
  es: {
    ...
    incomeOfMonth: "Ingresos del mes",
    lossOfMonth: "Perdidas del mes",
    compared: "comparado con el mes anterior",
    ...
    searchCategory: "Buscar por nombre de categoria",
